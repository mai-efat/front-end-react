  ...
  return (
    <section className={styles.hero}>
      <div className={styles.heroText}>
        <span className={styles.eyebrow}>BUILT FOR MODERN OPS TEAMS</span>
        ...
        <p>
          Synkra watches every process in your stack, catches the work that
          falls between tools, and turns it automatically without slowing your
          team down.
        </p>
        ...
        <small>No credit card required. No complicated setup.</small>
      </div>

      <div className={styles.heroImage}>
        <img src={Heroimg} alt="Synkra workflow dashboard preview" />
      </div>
    </section>
  );
}
  ...
  return (
    <section className={styles.stats}>
      ...
      <p className={styles.statsIntro}>
        Measured across live teams using Synkra&apos;s built-in run tracking and
        time saved
        <br />
      ...
      <div className={styles.statsButtons}>
        <button className={styles.statsPrimaryButton}>Create an Account</button>
      ...
      <p className={styles.statsNote}>
        <b>*</b>Ship your first live playbook in 10 minutes. No credit card, no
        setup call required.
      </p>
    </section>
  );
  ...
  const renderCard = (card) => (
    <div key={card.id} className={styles.card}>
      ...
      <div className={styles.authorWrapper}>
        <img src={card.avatar} alt={card.author} className={styles.avatar} />
        <div>
        ...
        <div className={styles.headerGrid}>
          ...
          <div>
            ...
            <p className={styles.headerDescription}>
              ...
              <strong>Synkra</strong> treats every workflow as a first class
              system, it listens, decides, acts, and records exactly what
              happened. So your team can trust the result.
            </p>
          </div>
        </div>
